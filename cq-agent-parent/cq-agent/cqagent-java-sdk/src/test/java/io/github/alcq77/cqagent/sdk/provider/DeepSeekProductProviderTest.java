...
public class DeepSeekProductProviderTest {

    @Test
    void shouldExposeDeepSeekProviderCodeAndBuildModels() {
        DeepSeekProductProvider provider = new DeepSeekProductProvider();
        ProductEndpointConfig endpoint = ProductEndpointConfig.builder()
            .id("deepseek-primary")
            .provider("deepseek")  // Use string literal instead of constant
            .apiKey("test-key")
