...
public class AzureOpenAiProductProviderTest {

    @Test
    void shouldExposeAzureOpenAiProviderCodeAndBuildModels() {
        AzureOpenAiProductProvider provider = new AzureOpenAiProductProvider();
        ProductEndpointConfig endpoint = ProductEndpointConfig.builder()
            .id("azure-primary")
            .provider("azure-openai")  // Use string literal instead of constant
